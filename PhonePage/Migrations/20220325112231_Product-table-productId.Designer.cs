...
namespace PhonePage.Migrations
{
    ...
    [Migration("20220325112231_Product-table-productId")]
    partial class ProducttableproductId
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PhonePage.Models.TeacherHobby", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("PhonePage.Models.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("PhonePage.Models.TeacherHobby", b =>
                {
                    b.HasOne("PhonePage.Models.Hobby", "Hobby")
                        .WithMany("TeacherHobbies")
                        .HasForeignKey("Hobbyid")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PhonePage.Models.Teacher", "Teacher")
                        .WithMany("TeacherHobbies")
